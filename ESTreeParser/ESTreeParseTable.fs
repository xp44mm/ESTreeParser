...
let rules:(string list*(obj list->obj))list = [
    ["file";"definitions"],fun(ss:obj list)->
    ...
    ["definitions";"definitions";"definition"],fun(ss:obj list)->
        ...
        let result:Definition list =
            s1::s0
        box result
    ["definition";"interfaceDefinition"],fun(ss:obj list)->
        let s0 = unbox<Definition> ss.[0]
        let result:Definition =
            s0
        box result
    ["definition";"enumDefinition"],fun(ss:obj list)->
        let s0 = unbox<Definition> ss.[0]
        let result:Definition =
            s0
        box result
    ["interfaceDefinition";"interfaceHead";"interfaceBody"],fun(ss:obj list)->
        ...
        let result:Definition =
            ...
            Interface(e,n,i,s1)
        box result
    ["interfaceHead";"INTERFACE";"ID"],fun(ss:obj list)->
        let s1 = unbox<string> ss.[1]
        let result:bool*string*list<string> =
            false,s1,[]
        box result
    ["interfaceHead";"EXTEND";"INTERFACE";"ID"],fun(ss:obj list)->
        let s2 = unbox<string> ss.[2]
        let result:bool*string*list<string> =
            true ,s2,[]
        box result
    ["interfaceHead";"INTERFACE";"ID";"<:";"ids"],fun(ss:obj list)->
        let s1 = unbox<string> ss.[1]
        let s3 = unbox<string list> ss.[3]
        let result:bool*string*list<string> =
            false,s1,s3
        box result
    ["interfaceHead";"EXTEND";"INTERFACE";"ID";"<:";"ids"],fun(ss:obj list)->
        let s2 = unbox<string> ss.[2]
        let s4 = unbox<string list> ss.[4]
        let result:bool*string*list<string> =
            true ,s2,s4
        box result
    ["ids";"ID"],fun(ss:obj list)->
        let s0 = unbox<string> ss.[0]
        let result:string list =
            [s0]
        box result
    ["ids";"ids";",";"ID"],fun(ss:obj list)->
        let s0 = unbox<string list> ss.[0]
        let s2 = unbox<string> ss.[2]
        let result:string list =
            s2::s0
        box result
    ["interfaceBody";"{";"}"],fun(ss:obj list)->
        let result:list<string*Annotation> =
            []
        box result
    ["interfaceBody";"{";"fields";"}"],fun(ss:obj list)->
        let s1 = unbox<list<string*Annotation>> ss.[1]
        let result:list<string*Annotation> =
            List.rev s1
        box result
    ...
    ["fields";"fields";"field"],fun(ss:obj list)->
        ...
        let result:list<string*Annotation> =
            s1::s0
        box result
    ["field";"ID";":";"annotation";";"],fun(ss:obj list)->
        let s0 = unbox<string> ss.[0]
        let s2 = unbox<Annotation> ss.[2]
        let result:string*Annotation =
            s0,s2
        box result
    ["annotation";"QUOTED"],fun(ss:obj list)->
        let s0 = unbox<string> ss.[0]
        let result:Annotation =
            StringLiteral s0
        box result
    ["annotation";"ID"],fun(ss:obj list)->
        let s0 = unbox<string> ss.[0]
        let result:Annotation =
            NamedType s0
        box result
    ["annotation";"annotation";"|";"annotation"],fun(ss:obj list)->
        ...
        let result:Annotation =
            ...
            | _ -> Union [s0;s2]
        box result
    ["annotation";"[";"annotation";"]"],fun(ss:obj list)->
        let s1 = unbox<Annotation> ss.[1]
        let result:Annotation =
            Array s1
        box result
    ["annotation";"interfaceBody"],fun(ss:obj list)->
        let s0 = unbox<list<string*Annotation>> ss.[0]
        let result:Annotation =
            Object s0
        box result
    ["enumDefinition";"enumHead";"enumBody"],fun(ss:obj list)->
        ...
        let result:Definition =
            ...
            Enum(e,n,s1)
        box result
    ["enumHead";"ENUM";"ID"],fun(ss:obj list)->
        let s1 = unbox<string> ss.[1]
        let result:bool*string =
            false,s1
        box result
    ["enumHead";"EXTEND";"ENUM";"ID"],fun(ss:obj list)->
        let s2 = unbox<string> ss.[2]
        let result:bool*string =
            true ,s2
        box result
    ["enumBody";"{";"}"],fun(ss:obj list)->
        let result:string list =
            []
        box result
    ["enumBody";"{";"cases";"}"],fun(ss:obj list)->
        let s1 = unbox<string list> ss.[1]
        let result:string list =
            List.rev s1
        box result
    ["cases";"QUOTED"],fun(ss:obj list)->
        let s0 = unbox<string> ss.[0]
        let result:string list =
            [s0]
        box result
    ["cases";"cases";"|";"QUOTED"],fun(ss:obj list)->
        let s0 = unbox<string list> ss.[0]
        let s2 = unbox<string> ss.[2]
        let result:string list =
            s2::s0
